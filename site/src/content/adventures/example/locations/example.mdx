...
areas:
  - name: Entrance
    ...
    content: |
      #### Occupants
      * 2 <MonsterLink monster="goblin">Goblins</MonsterLink>
      * 2 <>Example Monster</>s with spellcasting ability. They can cast <>Example Spell</>.
      ...
      * Any dice formulas in text can be turned into buttons to roll from!
          * example: <>d20</>, <>5d6</>, it's so easy - <>3d12+3</>! Just wrap them in Dice tags (ex: `<>2d6</>`).
      #### Developments
